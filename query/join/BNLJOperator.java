        ...
        private Record fetchNextRecord() {
            ...
            while(true) {
                if (rightPageIterator.hasNext()) {
                    ...
                    // The right page iterator doesn't have a value to yield
                    // but the left block iterator does
                    leftRecord = leftBlockIterator.next();
                    rightPageIterator.reset();
                } else if (rightSourceIterator.hasNext()) {
                    // Neither the right page nor left block iterators have values to yield,
                    // but there's more right pages
                    leftBlockIterator.reset();
                    leftRecord = leftBlockIterator.next();
                    fetchNextRightPage();
                } else if (leftSourceIterator.hasNext()) {
                    // Neither right page nor left block iterators have values nor are there more right pages,
